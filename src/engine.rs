...
const METRICS: &[(&str, &str, &str, bool, &str)] = &[
    ...
    ("binance", "BTC_FUNDING", "CRYPTO_DERIVATIVES", false, "stress"),
    ("binance", "BTC_OI", "CRYPTO_DERIVATIVES", false, "vulnerability"),
    ("treasury", "AUCTION_BTC", "TREASURY_AUCTION", true, "stress"),
...
pub fn run(db: &Db) -> Result<Snapshot, Box<dyn std::error::Error>> {
    ...
    ctx.scores.insert("VULNERABILITY_SCORE".into(), vulnerability_score);
