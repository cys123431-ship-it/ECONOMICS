...
| 수집 | FRED/ALFRED 28계열, Treasury 개별 CUSIP+일별 집계, Binance 7개 파생계열, ECOS 페이지네이션, KRX 6개 공식 고정 엔드포인트와 설정형 공식 JSON 어댑터를 구현한다. | 실제 공개 Treasury·Binance 스모크 수집, KRX 승인상태 사전점검 및 저장 건수 확인 |
